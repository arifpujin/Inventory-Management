...
<html lang="en-us" class="no-js">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="assets/errors/css/style.css" />
	...
	<body>
        ...
        <a onclick="history.back(-1)" class="logo-link" title="back home">

            <img src="assets/images/logo.png" class="logo" alt="Company's logo" />
    ...
    <footer class="light">
        <ul>
            <li><a href="https://unytechtv.com/">Support</a></li>
            <li><a href="https://instagram.com/unytech.tv"><i class="fa fa-instagram"></i></a></li>
            <li><a href="https://youtube.com/UNYtechTV"><i class="fa fa-youtube"></i></a></li>
        </ul>
    </footer>
        <script src="assets/errors/js/jquery.min.js"></script>
        <script src="assets/errors/js/bootstrap.min.js"></script>
        <!-- Slideshow plugin -->
        <script src="assets/errors/js/vegas.js"></script>
